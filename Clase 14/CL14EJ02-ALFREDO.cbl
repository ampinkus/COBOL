      ...
      * Si los 5 archivos se puedieron abrir correctamente
           IF FS-EMPLEADOS-OK AND FS-DIRECCIONES-OK AND FS-APAREO-OK
              AND FS-ERROR-OK AND FS-DATOS-EXTRA-OK

      * Proceso el programa hasta que no haya mas empleados ni direcciones
      ...
      * Pongo un valor muy alto en ID-empleados
                    MOVE 9999999           TO WS-ENT-EMP-ID-EMPLEADO
               WHEN OTHER
      ...
      * Pongo un valor muy alto en ID direcciones
      ...
      * Pongo un valor muy alto en el ID de datos extra
      ...
      * Proceso el apareo de datos extra
      * Si el ID del empleado es mayor que el ID de datos extra leo un
      * registro del archivo de datos extra para ver si hay una coincidencia
                 WHEN WS-ENT-EMP-ID-EMPLEADO > WS-ENT-EXT-ID-EMPLEADO
                   PERFORM 1510-LEER-DATOS-EXTRA
                   THRU 1510-LEER-DATOS-EXTRA-FIN
      * Si el ID del empleado es menor que el ID de datos extra
      * no hay datos extra para ese empleado y grabo el ERROR
                  WHEN WS-ENT-EMP-ID-EMPLEADO < WS-ENT-EXT-ID-EMPLEADO
                   PERFORM 2420-GRABAR-ERROR-SIN-EXTRA
                   THRU 2420-GRABAR-ERROR-SIN-EXTRA-FIN
