      ...
      *----------------------------------------------------------------*
       ...
       2410-ESCRIBIR-ERROR-FIN.
           EXIT.
      *----------------------------------------------------------------*
       2420-GRABAR-ERROR-SIN-EXTRA.

           MOVE WS-ENT-EMP-ID-EMPLEADO     TO WS-SAL-ERR-SE-ID-EMPLEADO.

           MOVE WS-SAL-ERR-SIN-EXTRA        TO WS-SAL-ERROR.
           PERFORM 2410-ESCRIBIR-ERROR
              THRU 2410-ESCRIBIR-ERROR-FIN.

       2420-GRABAR-ERROR-SIN-EXTRA-FIN.
           EXIT.
      *----------------------------------------------------------------*
