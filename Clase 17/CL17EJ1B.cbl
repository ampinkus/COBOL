      ...
      *----------------------------------------------------------------*
       ...
       01 ENT-PRODUCTOS.
          ...
          05 ENT-LISTA-IMPORTES             REDEFINES ENT-VALORES.
             10 ENT-LISTA-VALORES-AUX       OCCURS 5 TIMES.
                15 ENT-IMPORTE              PIC 9(02)V9(02).
      ...
      *----------------------------------------------------------------*
       2200-PROCESAR-VECTOR.
           ...
           PERFORM VARYING WS-INDICE FROM 2 BY 1 UNTIL WS-INDICE > 5
