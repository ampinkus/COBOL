      ...
      * Agrego los datos extra por si existen
          05 ENT-EMP-TIPO-DOC               PIC X(03).
          05 ENT-EMP-NRO-DOC                PIC X(08).
          05 ENT-EMP-TELEFONO               PIC X(09).
      ...
      *----------------------------------------------------------------*
       2000-PROCESAR-PROGRAMA.
           ...
           DISPLAY 'ID-EMPLEADO: ' ENT-EMP-ID-EMPLEADO ' - '-
                   ...
                   "TIPO DOCUMENTO: " ENT-EMP-TIPO-DOC  ' - '-
                   "NUMERO DOCUMENTO: " ENT-EMP-NRO-DOC ' - '-
                   "TELEFONO: " ENT-EMP-TELEFONO ' - ' .
