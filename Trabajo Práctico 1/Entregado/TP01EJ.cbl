      ...
      * Cuando lee el último registro como hay un EOF no detecta el
      ...
      *  Controlo que la materia no este en blanco
           ...
           IF NOTA IS NOT NUMERIC
               ...
               OR FECHA EQUAL SPACES
               OR FECHA EQUAL LOW-VALUES
               OR FECHA EQUAL HIGH-VALUES
               THEN
